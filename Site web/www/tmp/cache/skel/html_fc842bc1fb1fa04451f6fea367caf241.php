...
/*
 * Squelette : ../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_b.html
 * Date :      Wed, 28 Sep 2011 21:24:13 GMT
 * Compile :   Wed, 29 Feb 2012 15:33:35 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_b.html
// Temps de compilation total: 1.805 ms
//

function html_fc842bc1fb1fa04451f6fea367caf241($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'</a>
		<a class="cke_selected" href="?exec=cfg&cfg=ckeditor_b">' .
...
<div class="ajax">
	' .
executer_balise_dynamique('FORMULAIRE_CKB',
	array(),
	array('../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_b.html','html_fc842bc1fb1fa04451f6fea367caf241','',25,$GLOBALS['spip_lang'])) .
'
</div>
');

	return analyse_resultat_skel('html_fc842bc1fb1fa04451f6fea367caf241', $Cache, $page, '../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_b.html');
}
?>