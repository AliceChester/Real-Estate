...
/*
 * Squelette : plugins/cimobile/squel_mobiles/iphone/header.html
 * Date :      Sat, 08 Oct 2011 14:57:30 GMT
...
/* BOUCLE articles  */
 ...
 function BOUCLE_titlehtml_7357b72ae491f15e7d4a18c68ebdec47(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/header.html','html_7357b72ae491f15e7d4a18c68ebdec47','_title',6,$GLOBALS['spip_lang']));
	if ($result) {
...
/* BOUCLE articles  */
 ...
 function BOUCLE_panhtml_7357b72ae491f15e7d4a18c68ebdec47(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/header.html','html_7357b72ae491f15e7d4a18c68ebdec47','_pan',136,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE articles  */
 ...
 function BOUCLE_traductionsshtml_7357b72ae491f15e7d4a18c68ebdec47(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/header.html','html_7357b72ae491f15e7d4a18c68ebdec47','_traductionss',154,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE articles  */
 ...
 function BOUCLE_tradarticlehtml_7357b72ae491f15e7d4a18c68ebdec47(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/header.html','html_7357b72ae491f15e7d4a18c68ebdec47','_tradarticle',153,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
'
	' .
BOUCLE_traductionsshtml_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	lang_select();
...
/* BOUCLE articles  */
 ...
 function BOUCLE_menuarthtml_7357b72ae491f15e7d4a18c68ebdec47(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/header.html','html_7357b72ae491f15e7d4a18c68ebdec47','_menuart',173,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE rubriques  */
 ...
 function BOUCLE_menurubhtml_7357b72ae491f15e7d4a18c68ebdec47(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/header.html','html_7357b72ae491f15e7d4a18c68ebdec47','_menurub',172,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
'
' .
BOUCLE_menuarthtml_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	lang_select();
...
//
// Fonction principale du squelette plugins/cimobile/squel_mobiles/iphone/header.html
// Temps de compilation total: 7.055 ms
//

function html_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
BOUCLE_titlehtml_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons, $Numrows, $SP) .
'</title>
...
' .
BOUCLE_panhtml_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
'
	...
	' .
BOUCLE_tradarticlehtml_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
' .
BOUCLE_menurubhtml_7357b72ae491f15e7d4a18c68ebdec47($Cache, $Pile, $doublons, $Numrows, $SP) .
'
	</ul>
</div>		
');

	return analyse_resultat_skel('html_7357b72ae491f15e7d4a18c68ebdec47', $Cache, $page, 'plugins/cimobile/squel_mobiles/iphone/header.html');
}
?>