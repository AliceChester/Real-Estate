...
/*
 * Squelette : plugins/cimobile/squel_mobiles/bberry/header.html
 * Date :      Sat, 08 Oct 2011 15:53:19 GMT
 * Compile :   Mon, 24 Oct 2011 01:14:46 GMT
 * Boucles :   _title, _traductionss, _tradarticle, _pan, _menuart, _menurub
 */ 

/* BOUCLE articles  */

 function BOUCLE_titlehtml_0b3a1529cc7c01627b0ddfcf040ea596(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/bberry/header.html','html_0b3a1529cc7c01627b0ddfcf040ea596','_title',6,$GLOBALS['spip_lang']));
	if ($result) {
...
/* BOUCLE articles  */
 ...
 function BOUCLE_traductionsshtml_0b3a1529cc7c01627b0ddfcf040ea596(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/bberry/header.html','html_0b3a1529cc7c01627b0ddfcf040ea596','_traductionss',171,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE articles  */
 ...
 function BOUCLE_tradarticlehtml_0b3a1529cc7c01627b0ddfcf040ea596(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/bberry/header.html','html_0b3a1529cc7c01627b0ddfcf040ea596','_tradarticle',170,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
'
	' .
BOUCLE_traductionsshtml_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	lang_select();
...
/* BOUCLE articles  */
 ...
 function BOUCLE_panhtml_0b3a1529cc7c01627b0ddfcf040ea596(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/bberry/header.html','html_0b3a1529cc7c01627b0ddfcf040ea596','_pan',179,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE articles  */
 ...
 function BOUCLE_menuarthtml_0b3a1529cc7c01627b0ddfcf040ea596(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/bberry/header.html','html_0b3a1529cc7c01627b0ddfcf040ea596','_menuart',195,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE rubriques  */
 ...
 function BOUCLE_menurubhtml_0b3a1529cc7c01627b0ddfcf040ea596(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/bberry/header.html','html_0b3a1529cc7c01627b0ddfcf040ea596','_menurub',194,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
'
' .
BOUCLE_menuarthtml_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	lang_select();
...
//
// Fonction principale du squelette plugins/cimobile/squel_mobiles/bberry/header.html
// Temps de compilation total: 6.530 ms
//

function html_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
BOUCLE_titlehtml_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons, $Numrows, $SP) .
'</title>
...
<h3 style="position: absolute; text-indent: -1000em;">Realestate caretaking, martine, hillion, paris, france,' .
...
<div style="float: right; padding-right: 7px; padding-top: 3px;">
	' .
BOUCLE_tradarticlehtml_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons, $Numrows, $SP) .
'
</div>

' .
BOUCLE_panhtml_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons, $Numrows, $SP) .
'


<div style="margin-top: 0px;" class="center"><a href="' .
...
' .
BOUCLE_menurubhtml_0b3a1529cc7c01627b0ddfcf040ea596($Cache, $Pile, $doublons, $Numrows, $SP) .
'
	</ul>
</div>		
<br/>
<img style="width: 100%" src="IMG/fond-mobile" alt="fond" />');

	return analyse_resultat_skel('html_0b3a1529cc7c01627b0ddfcf040ea596', $Cache, $page, 'plugins/cimobile/squel_mobiles/bberry/header.html');
}
?>