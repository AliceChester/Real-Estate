...
/*
 * Squelette : ../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor.html
 * Date :      Wed, 28 Sep 2011 21:24:13 GMT
 * Compile :   Wed, 29 Feb 2012 15:33:35 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor.html
// Temps de compilation total: 4.973 ms
//

function html_368aac4119ff7a7fbd87ae4fb2696756($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'<?php header("X-Spip-Cache: 0"); ?>'.'<?php header("Cache-Control: no-store, no-cache, must-revalidate"); ?><?php header("Pragma: no-cache"); ?><div id="cke_onglets">
		<a class="cke_selected" href="?exec=cfg&cfg=ckeditor">' .
...
<div class="ajax">
	' .
executer_balise_dynamique('FORMULAIRE_CKA',
	array(),
	array('../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor.html','html_368aac4119ff7a7fbd87ae4fb2696756','',23,$GLOBALS['spip_lang'])) .
'
</div>
');

	return analyse_resultat_skel('html_368aac4119ff7a7fbd87ae4fb2696756', $Cache, $page, '../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor.html');
}
?>