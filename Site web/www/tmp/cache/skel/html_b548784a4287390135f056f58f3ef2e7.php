...
/*
 * Squelette : plugins/cimobile/squel_mobiles/iphone/rubrique.html
 * Date :      Mon, 26 Sep 2011 21:51:28 GMT
...
/* BOUCLE articles  */
 ...
 function BOUCLE_articleshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_articles',74,$GLOBALS['spip_lang']));
	if ($result) {
...
/* BOUCLE boucle  */
 ...
 function BOUCLE_rehtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {

	static $connect = '';
	$save_numrows = ($Numrows['_sous_rubriques']);
	$t0 = (($t1 = BOUCLE_sous_rubriqueshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
...
/* BOUCLE rubriques  */
 ...
 function BOUCLE_test_exposehtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_test_expose',133,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
/* BOUCLE rubriques  */
 ...
 function BOUCLE_sous_rubriqueshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_sous_rubriques',129,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
	while ($Pile[$SP] = @sql_fetch($result)) {
		...
		lang_select_public($Pile[$SP]['lang'], '', $Pile[$SP]['titre']);
		$t0 .= (($t1 = BOUCLE_test_exposehtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		($t1 . (	'
...
<li><a href="' .
		...
		'</a>' .
		BOUCLE_rehtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP) .
		'	</li>
...
/* BOUCLE rubriques  */
 ...
 function BOUCLE_rubriqueshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_rubriques',108,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
' .
(($t1 = BOUCLE_sous_rubriqueshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
...
/* BOUCLE documents  */
 ...
 function BOUCLE_documents_jointshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_documents_joints',159,$GLOBALS['spip_lang']));
	if ($result) {
...
/* BOUCLE breves  */
 ...
 function BOUCLE_breveshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_breves',187,$GLOBALS['spip_lang']));
	if ($result) {
...
/* BOUCLE syndic_articles  */
 ...
 function BOUCLE_syndichtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_syndic',229,$GLOBALS['spip_lang']));
	if ($result) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP] = @sql_fetch($result)) {
...
/* BOUCLE syndication  */
 ...
 function BOUCLE_siteshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_sites',214,$GLOBALS['spip_lang']));
	if ($result) {
...
' .
(($t1 = BOUCLE_syndichtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
...
/* BOUCLE mots  */
 ...
 function BOUCLE_motshtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_mots',272,$GLOBALS['spip_lang']));
	if ($result) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP] = @sql_fetch($result)) {
...
<li><a href="' .
interdire_scripts(generer_url_public('bberry_mot',(	'id_mot=' .
	$Pile[$SP]['id_mot']))) .
'" rel="tag"><h3>' .
interdire_scripts(traiter_doublons_documents($doublons, typo(supprimer_numero($Pile[$SP]['titre']),"TYPO",$connect))) .
'</h3></a></li>
...
/* BOUCLE rubriques  */
 ...
 function BOUCLE_principalehtml_b548784a4287390135f056f58f3ef2e7(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_principale',7,$GLOBALS['spip_lang']));
	if ($result) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
	// RESULTATS
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inc/inc-head') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'plugins/cimobile/squel_mobiles/iphone/rubrique.html\',\'html_b548784a4287390135f056f58f3ef2e7\',\'\',20,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inc/inc-entete') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'plugins/cimobile/squel_mobiles/iphone/rubrique.html\',\'html_b548784a4287390135f056f58f3ef2e7\',\'\',36,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>	
...
' .
(($t1 = BOUCLE_articleshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
' .
(($t1 = BOUCLE_rubriqueshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
' .
(($t1 = BOUCLE_documents_jointshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
' .
(($t1 = BOUCLE_breveshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
' .
(($t1 = BOUCLE_siteshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
executer_balise_dynamique('FORMULAIRE_SITE',
	...
	array('plugins/cimobile/squel_mobiles/iphone/rubrique.html','html_b548784a4287390135f056f58f3ef2e7','_principale',259,$GLOBALS['spip_lang'])) .
'
...
' .
(($t1 = BOUCLE_motshtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inc/inc-rubriques') . ', array(\'id_rubrique\' => ' . argumenter_squelette($Pile[$SP]['id_rubrique']) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'plugins/cimobile/squel_mobiles/iphone/rubrique.html\',\'html_b548784a4287390135f056f58f3ef2e7\',\'\',303,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
//
// Fonction principale du squelette plugins/cimobile/squel_mobiles/iphone/rubrique.html
// Temps de compilation total: 185.645 ms
//

function html_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
BOUCLE_principalehtml_b548784a4287390135f056f58f3ef2e7($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
');
	...
	return analyse_resultat_skel('html_b548784a4287390135f056f58f3ef2e7', $Cache, $page, 'plugins/cimobile/squel_mobiles/iphone/rubrique.html');
}
?>