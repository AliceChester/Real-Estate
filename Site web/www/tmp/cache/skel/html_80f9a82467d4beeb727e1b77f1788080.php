...
/*
 * Squelette : ../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_h.html
...
/* BOUCLE CONDITION  */
 ...
 function BOUCLE_sihtml_80f9a82467d4beeb727e1b77f1788080(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_h.html','html_80f9a82467d4beeb727e1b77f1788080','_si',25,$GLOBALS['spip_lang']));
	if ($result) {
	$SP++;
	// RESULTATS
...
'
	' .
executer_balise_dynamique('FORMULAIRE_CKH',
	array(),
	array('../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_h.html','html_80f9a82467d4beeb727e1b77f1788080','_si',26,$GLOBALS['spip_lang'])) .
'
');
	}
...
//
// Fonction principale du squelette ../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_h.html
// Temps de compilation total: 5.481 ms
//

function html_80f9a82467d4beeb727e1b77f1788080($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'</a>
		<a class="cke_selected" href="?exec=cfg&cfg=ckeditor_h">' .
...
<div>
' .
(($t1 = BOUCLE_sihtml_80f9a82467d4beeb727e1b77f1788080($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		$t1 :
		((	'
' .
	_T('ckeditor:spipbalise_necessite_iterateurs') .
	'
'))) .
'
</div>
');
	...
	return analyse_resultat_skel('html_80f9a82467d4beeb727e1b77f1788080', $Cache, $page, '../plugins/ckeditor-spip-plugin/fonds/cfg_ckeditor_h.html');
}
?>