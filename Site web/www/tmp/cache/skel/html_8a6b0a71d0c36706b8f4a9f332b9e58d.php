 ...
 * Compile :   Sun, 23 Oct 2011 13:46:30 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette squelettes-dist/inc-pied.html
// Temps de compilation total: 45.393 ms
//
...
' .
"<!-- SPIP-CRON --><div style=\"background-image: url('http://realestatecaretaking.com/spip.php?action=cron');\"></div>" .
'
');
