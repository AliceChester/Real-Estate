 ...
 * Date :      Sun, 03 Apr 2011 15:43:47 GMT
 * Compile :   Wed, 26 Oct 2011 21:50:49 GMT
...
/* BOUCLE articles  */
 ...
 function BOUCLE_10recentshtml_6e2efe63dd9202a6371932853505f2fb(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$where = 
			...
			array('<', 'articles.date', sql_quote(quete_date_postdates())), (!$Pile[0]['lang'] ? '' : ((is_array($Pile[0]['lang'])) ? sql_in('articles.lang',sql_quote($in)) : 
...
// Temps de compilation total: 73.682 ms
//
