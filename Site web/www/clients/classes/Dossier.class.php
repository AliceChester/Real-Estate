	...
	class Dossier extends Baseobj{
		...
		function supprimer(){
			...
			if( ! mysql_num_rows($resul) && ! mysql_num_rows($resul2)){
				...
				$query = "select * from $image->table where dossier=\"" . $this->id . "\" AND contenu=\"0\" AND produit=\"0\" AND rubrique=\"0\" ";
				...
				$query = "select * from $document->table where dossier=\"" . $this->id . "\" AND contenu=\"0\" AND produit=\"0\" AND rubrique=\"0\" ";
