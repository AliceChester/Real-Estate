	...
	class Rubrique extends Baseobj{
		...
		function supprimer(){
			...
			if( ! mysql_num_rows($resul) && ! mysql_num_rows($resul2)){
				...
				$query = "select * from $image->table where rubrique=\"" . $this->id . "\" AND dossier=\"0\" AND contenu=\"0\" AND produit=\"0\" ";
				...
				$query = "select * from $document->table where rubrique=\"" . $this->id . "\" AND dossier=\"0\" AND contenu=\"0\" AND produit=\"0\" ";
