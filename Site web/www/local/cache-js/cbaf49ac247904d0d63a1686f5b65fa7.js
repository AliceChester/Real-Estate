...
.find('img')
.attr('src','http://www.realestatecaretaking.com/plugins/ckeditor-spip-plugin/images/searching.gif');
...
.find('img')
.attr('src','http://www.realestatecaretaking.com/plugins/ckeditor-spip-plugin/images/ckeditor_spip.png')
.end()
.attr('disabled','');
...
.find('img')
.attr('src','http://www.realestatecaretaking.com/plugins/ckeditor-spip-plugin/images/ckeditor.png')
.end()
.attr('disabled','');
$(editor_id)
.attr('disabled','')}
...
+'"><img src="http://www.realestatecaretaking.com/plugins/ckeditor-spip-plugin/images/ckeditor.png"/></button>'}
;
if(buttons)
...
.after('<button id="save" style=\'background:url("http://www.realestatecaretaking.com/plugins/auto/crayons/images/ok.png") no-repeat scroll left top transparent;\' onclick="javascript:return cke_crayon_submit(\''+editor_id+'\');" title="Enregistrer">Enregistrer</button>')
.remove()}
}
