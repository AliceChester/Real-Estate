<?php /* Smarty version 2.6.26, created on 2014-06-30 13:51:31
...
, <?php echo $this->_tpl_vars['site']['revenue']; ?>
...
', '<?php echo ((is_array($_tmp=$this->_tpl_vars['site']['revenueSummaryValue'])) ? $this->_run_mod_handler('replace', true, $_tmp, ",", ".") : smarty_modifier_replace($_tmp, ",", ".")); ?>
');
